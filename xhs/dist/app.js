...
const STATIONS = [
  ...
  // ===== 车站补齐 (2026-09: 永城等郑徐沿线 + 各地级市/热门目的地) =====
  ["永城北","永城",33.929,116.436,0],["兰考南","兰考",34.78,114.86,0],["民权北","民权",34.648,115.17,0],
  ["砀山南","砀山",34.42,116.36,0],["萧县北","萧县",34.19,116.96,0],["济源","济源",35.067,112.59,0],
  ["宿州东","宿州",33.647,116.984,0],["乌兰浩特","兴安",46.083,122.067,0],["阿尔山","兴安",47.177,119.944,0],
  ["锡林浩特","锡林郭勒",43.933,116.083,0],["二连浩特","锡林郭勒",43.653,111.982,0],["额济纳","阿拉善",41.967,101.067,0],
  ["辽源","辽源",42.887,125.143,0],["北戴河","秦皇岛",39.834,119.484,0],["山海关","秦皇岛",39.988,119.765,0],
  ["千岛湖","杭州",29.607,119.064,0],["桐乡","嘉兴",30.653,120.512,0],["平遥古城","晋中",37.19,112.185,0],
  ["婺源","上饶",29.248,117.862,0],["井冈山","吉安",26.748,114.164,0],["武夷山北","南平",27.758,118.035,0],
  ["泰宁","三明",26.918,117.123,0],["韶山","湘潭",27.915,112.528,0],["凤凰古城","湘西",27.985,109.602,0],
  ["神农架","神农架",31.744,110.678,0],["河池西","河池",24.695,108.06,0],["广安南","广安",30.474,106.633,0],
  ["雅安","雅安",30.01,103.001,0],["巴中","巴中",31.858,106.754,0],["九寨沟","阿坝",33.161,104.235,0],
  ["昭通","昭通",27.338,103.717,0],["楚雄","楚雄",25.045,101.546,0],["文山","文山",23.369,104.244,0],
  ["芒市","德宏",24.433,98.588,0],["香格里拉","迪庆",27.829,99.706,0],["山南","山南",29.238,91.766,0],
  ["铜川","铜川",34.897,108.945,0],["商洛","商洛",33.868,109.94,0],["白银西","白银",36.545,104.181,0],
  ["定西","定西",35.581,104.626,0],["临夏","临夏",35.601,103.212,0],["门源","海北",37.376,101.622,0],
  ["共和","海南",36.284,100.62,0],["玉树","玉树",33.005,97.008,0],["固原","固原",36.004,106.242,0],
  ["昌吉","昌吉",44.014,87.304,0],["博乐","博尔塔拉",44.854,82.074,0],["阿图什","克孜勒苏",39.716,76.168,0],
  ["塔城","塔城",46.746,82.979,0],["阿勒泰","阿勒泰",47.845,88.14,0],["漠河","大兴安岭",52.972,122.539,0],
  ["满洲里","呼伦贝尔",49.586,117.399,0],["长白山","白山",42.377,128.129,0],
  // ===== 车站补全第二批 (2026-09-16: 沿江/沿海/高铁县市站) =====
  ["启东","启东",31.808,121.657,0],["海门","海门",31.869,121.18,0],["如皋","如皋",32.376,120.56,0],
["海安","海安",32.545,120.468,0],["泰兴","泰兴",32.172,120.052,0],["靖江","靖江",32.014,120.276,0],
["丹阳","丹阳",31.996,119.585,0],["句容","句容",31.945,119.008,0],["溧阳","溧阳",31.416,119.484,0],
["宜兴","宜兴",31.36,119.82,0],["江阴","江阴",31.911,120.285,0],["张家港","张家港",31.875,120.555,0],
["常熟","常熟",31.654,120.752,0],["太仓","太仓",31.452,121.108,0],["昆山南","苏州",31.386,120.98,0],
["吴江","苏州",31.16,120.645,0],["东台","东台",32.853,120.32,0],["大丰","盐城",33.199,120.501,0],
["射阳","射阳",33.776,120.257,0],["滨海","滨海",33.989,119.82,0],["响水","响水",34.199,119.579,0],
["灌云","灌云",34.29,119.255,0],["灌南","灌南",34.09,119.352,0],["东海","东海",34.542,118.771,0],
["泗阳","泗阳",33.721,118.703,0],["泗洪","泗洪",33.459,118.216,0],["沭阳","沭阳",34.115,118.799,0],
["盱眙","盱眙",33.011,118.544,0],["金湖","金湖",33.025,119.02,0],["宝应","宝应",33.236,119.36,0],
["高邮","高邮",32.785,119.455,0],["兴化","兴化",32.91,119.853,0],["姜堰","泰州",32.508,120.126,0],
["舟山","舟山",29.985,122.207,0],["慈溪","慈溪",30.17,121.266,0],["余姚","余姚",30.037,121.154,0],
["奉化","奉化",29.657,121.406,0],["宁海","宁海",29.288,121.43,0],["象山","象山",29.477,121.869,0],
["诸暨","诸暨",29.713,120.236,0],["嵊州","嵊州",29.588,120.82,0],["新昌","新昌",29.5,120.905,0],
["上虞","绍兴",30.033,120.874,0],["永康","永康",28.889,120.037,0],["兰溪","兰溪",29.209,119.461,0],
["东阳","东阳",29.29,120.241,0],["武义","武义",28.893,119.814,0],["江山","江山",28.735,118.627,0],
["龙游","龙游",29.028,119.172,0],["常山","常山",28.901,118.511,0],["开化","开化",29.137,118.415,0],
["温岭","温岭",28.371,121.385,0],["临海","临海",28.858,121.145,0],["天台","天台",29.193,121.007,0],
["三门","三门",29.104,121.394,0],["建德","建德",29.476,119.281,0],["桐庐","桐庐",29.793,119.688,0],
["安吉","安吉",30.639,119.68,0],["长兴","长兴",30.993,119.91,0],["德清","德清",30.542,119.978,0],
["嘉善","嘉善",30.83,120.92,0],["海宁","海宁",30.51,120.68,0],["平湖","平湖",30.677,121.019,0],
["海盐","海盐",30.526,120.946,0],["虎门","东莞",22.819,113.673,0],["常平","东莞",22.982,114.01,0],
["顺德","佛山",22.833,113.25,0],["三水","佛山",23.169,112.897,0],["开平","江门",22.377,112.698,0],
["台山","江门",22.251,112.794,0],["恩平","江门",22.183,112.305,0],["鹤山","江门",22.765,112.964,0],
["四会","肇庆",23.327,112.734,0],["英德","清远",24.187,113.401,0],["兴宁","梅州",24.138,115.731,0],
["五华","梅州",23.925,115.778,0],["普宁","揭阳",23.298,116.166,0],["惠来","揭阳",23.033,116.296,0],
["饶平","潮州",23.669,117.004,0],["海丰","汕尾",22.966,115.328,0],["陆丰","汕尾",22.949,115.652,0],
["龙川","河源",24.1,115.26,0],["阳春","阳江",22.171,111.79,0],["电白","茂名",21.514,111.016,0],
["化州","茂名",21.665,110.639,0],["高州","茂名",21.918,110.853,0],["信宜","茂名",22.354,110.941,0],
["吴川","湛江",21.441,110.78,0],["雷州","湛江",20.914,110.096,0],["徐闻","湛江",20.326,110.176,0],
["章丘","济南",36.712,117.526,0],["即墨","青岛",36.39,120.447,0],["胶州","青岛",36.264,120.033,0],
["平度","青岛",36.786,119.96,0],["莱西","青岛",36.888,120.517,0],["滕州","枣庄",35.106,117.159,0],
["龙口","烟台",37.658,120.478,0],["莱州","烟台",37.177,119.942,0],["蓬莱","烟台",37.811,120.759,0],
["海阳","烟台",36.689,121.158,0],["莱阳","烟台",36.98,120.712,0],["青州","潍坊",36.685,118.48,0],
["诸城","潍坊",35.996,119.41,0],["寿光","潍坊",36.857,118.791,0],["高密","潍坊",36.383,119.756,0],
["兖州","济宁",35.556,116.826,0],["邹城","济宁",35.405,116.966,0],["荣成","威海",37.165,122.487,0],
["文登","威海",37.196,122.058,0],["乳山","威海",36.92,121.54,0],["莒县","日照",35.58,118.837,0],
["沂水","临沂",35.79,118.628,0],["费县","临沂",35.266,117.978,0],["平邑","临沂",35.506,117.639,0],
["郯城","临沂",34.614,118.367,0],["乐陵","德州",37.73,117.231,0],["禹城","德州",36.934,116.638,0],
["齐河","德州",36.783,116.762,0],["临清","聊城",36.838,115.706,0],["曹县","菏泽",34.826,115.542,0],
["郓城","菏泽",35.6,115.944,0],["奉节","重庆",31.018,109.463,0],["巫山","重庆",31.074,109.879,0],
["利川","恩施",30.29,108.936,0],["阳朔","桂林",24.778,110.497,0],["荔波","黔南",25.412,107.883,0],
["芷江","怀化",27.443,109.685,0],["通道","怀化",26.158,109.784,0]
];
...
const BLK2 = [
  ['武汉', '广州', '深圳'], ['南宁', '济南', '天津'],
  ['海口', '沈阳', '福州'], ['海口', '哈尔滨', '福州'],
  // 2026-09-16 实测: 区间 成都⇄黄石, 票面 黄石→哈尔滨 经 武汉/合肥/北京/襄阳 全拒(区间不符)
  //   destT=1.981, destP=1771km —— 目的地远超端点, 中转也救不了
  ['成都', '黄石', '哈尔滨'],
  // 2026-09-19 实测: 区间 郑州⇄新乡(L=67km), 票面 郑州→天津(距端点578km≤600) 12306 拦"区间不符"
  //   推翻"极短区间同城圈600km"的普适性: 苏沪→武汉596 可出 / 郑新乡→天津578 拦, 无半径阈值可同时满足
  //   固执反例按惯例走 BLK2; 区间推荐排序改用 beltV2Robust(不依赖该退化分支)
  ['郑州', '新乡', '天津'],
];
const RAIL_LINES = [
  ['哈尔滨', '长春', '沈阳', '北京'],                         // 京哈
  ...
  ['兰州', '西宁', '拉萨'],                                  // 青藏(近似)
  ['杭州', '宁波', '台州', '温州', '宁德', '福州', '莆田', '泉州', '厦门', '漳州', '潮汕', '汕尾', '惠州', '深圳'],
  ['郑州', '开封', '兰考', '民权', '商丘', '砀山', '永城', '萧县', '徐州'],
  ['北京', '廊坊', '天津', '沧州', '德州', '济南', '泰安', '济宁', '枣庄', '徐州', '宿州', '蚌埠', '滁州', '南京', '镇江', '常州', '无锡', '苏州', '上海'],
  ['北京', '衡水', '聊城', '菏泽', '商丘', '阜阳', '九江', '南昌', '吉安', '赣州', '深圳'],
  ['上海', '嘉兴', '杭州', '绍兴', '上饶', '鹰潭', '南昌', '新余', '宜春', '萍乡', '长沙', '株洲', '娄底', '怀化', '铜仁', '贵阳', '安顺', '昆明'],
  ['连云港', '徐州', '商丘', '开封', '郑州', '洛阳', '三门峡', '渭南', '西安', '宝鸡', '天水', '兰州'],
  ['衡阳', '永州', '桂林', '柳州', '来宾', '南宁'],
  ['南宁', '贵港', '梧州', '广州'],
  ['广州', '东莞', '深圳'],
  ['北京', '保定', '石家庄', '邢台', '邯郸', '安阳', '新乡', '郑州', '许昌', '漯河', '驻马店', '信阳', '孝感', '武汉', '岳阳', '长沙', '衡阳', '郴州', '韶关', '广州'],
  ['武汉', '鄂州', '黄石'],
  ['成都', '资阳', '内江', '重庆'],
  ['昆明', '楚雄', '大理'],
  ['南宁', '百色', '昆明'],
...
function bandOK(S, H, P) {
  const L = dist(S, H);
  // 真·同城圈(L<105): 端点近邻≤600km 放行 —— 全部实测依据:
  //   广州⇄佛山 27km → 深圳89/珠海/中山/东莞/厦门515 全放行 ✅
  //   苏州⇄上海 80km → 合肥322/徐州458/武汉596 放行, 北京1028 拦截 ✅
  //   滁州⇄镇江107km → 上海211/济南501 被拒(仅武汉经中转可出) ❌
  //   南京⇄合肥142km → 开封440/长沙575 被拒 ❌
  // 阈值 105 卡在 苏沪80(宽松成立) 与 滁镇107(不成立) 之间。
  if (L < 105) return dist(S, P) <= 600 || dist(H, P) <= 600;
  const { t, p } = corridor(S, H, P);
  // 校侧端点外(t<-0.15): 原为直接拦截, 但实测 南京⇄合肥142km 下 镇江(t=-0.44,距南京64km)、
  // 扬州东(t=-0.52,距南京84km) 均可出 —— 短区间会把距起点很近的点投影成很小的负数 t,
  // 单看 t 会误杀; 改为 t<-0.15 时按距起点距离兜底(<=150km 视为端点圈内, 放行)
  if (t > 1.2) return false;
  if (t < -0.15 && dist(S, P) > 150) return false;
...
function chanOK(S, H, P) {
  ...
  // 端点或目的地任一不在通道网内 → 统一退化几何判定
  // (旧口径只查端点: 目的地出图时直接 false → 区间内近邻站被误判超区间)
  if (!g.nodes.has(S.city) || !g.nodes.has(H.city) || !g.nodes.has(P.city)) return bandOK(S, H, P);
  const L = dist(S, H);
...
/* 区间级例外 */
/* 雷州半岛-海南链: 无过路车流的末端支线, 直达一律拦截
 * (实测: 湛江/湛江西/海口/三亚 拦; 北海/防城港/茂名 放) —— 原靠“不入图自然拦截”实现 */
const CHAIN_BLK = ['湛江', '海口', '三亚', '儋州', '东方', '文昌', '琼海', '万宁', '徐闻'];
/* 仅区间级固执例外 BLK2(不含雷州-海南链)
 * 用于中转分支: 实测 黄石→湛江 中转可出, 故不能用 CHAIN_BLK 一刀切 */
function isBLK2(S, H, P) {
  if (!P) return false;
...
function isBlack(S, H, P) {
  ...
  // 链上站作为终点(且不是区间端点) → 拦; 端点自身在链上时不拦
  if (P && P.city && CHAIN_BLK.indexOf(P.city) >= 0 && CHAIN_BLK.indexOf(S && S.city) < 0 && CHAIN_BLK.indexOf(H && H.city) < 0) return true;
  return false;
}
...
function near50Map() {
  ...
  for (let i = 0; i < STATIONS.length; i++) {
    ...
    for (let j = 0; j < STATIONS.length; j++) {
      if (i === j) continue;
      if (dist(pts[i], pts[j]) <= 40) list.push(STATIONS[j][0]);
    }
  }
  return _near50;
}
...
function nearOK(S, H) {
  ...
  const n50 = near50Map();
  // 同城/紧邻传播一轮(与 rules-notes 原文一致): 种子 → 一跳≤50km 邻接 → 同城一轮。
  // 原无界 BFS 会沿 50km 链多跳传导(肇庆→佛山→广州), 把距区间 700km+ 的城市拖进区间
  const seeds = [...set];
  for (const cur of seeds) for (const nb of (n50[cur] || [])) set.add(nb);
  for (const s of STATIONS) {
    if (set.has(s[0])) continue;
    if ((byCity[s[1]] || []).some(x => set.has(x[0]))) set.add(s[0]);
  }
  _nearCache = { key, set };
  return set;
}
...
function beltV2(S, H, P, fast) {
  ...
  if (dist(S, P) <= 40 || dist(H, P) <= 40) return 2; // 端点近邻/同城(实测 长株潭25/广佛25km; 50→40 防虎门→深圳北41km 泄漏)
  if (bandOK(S, H, P) && chanOK(S, H, P)) return 2;
  return (!fast && nearOK(S, H).has(P.name)) ? 2 : 0;
}

/* ---------- 稳健口径(仅供区间推荐排序, 不替代出票判定 beltV2) ----------
 * bandOK 的 L<105 分支("极短区间同城圈": 端点600km内放行)仅由 广佛/苏沪 两组实测支撑,
 * 2026-09-19 用户实测 郑州⇄新乡(L=67km)→天津(578km≤600) 被 12306 拦"区间不符" ——
 * 该退化分支不能作为"改家建议"的覆盖依据。稳健口径 = 同一套 t/p 走廊带 + 通道网,
 * 但不走极短区间捷径; 只会比 beltV2 更严(L≥105 时与 beltV2 完全一致)。 */
function bandOKStrict(S, H, P) {
  const L = dist(S, H);
  if (L < 15) return dist(S, P) <= 50;
  const { t, p } = corridor(S, H, P);
  if (t > 1.2) return false;
  if (t < -0.15 && dist(S, P) > 150) return false;
  const w = (t < 0) ? Math.max(250, 0.2 * L)
    : (t > 1) ? Math.max(75, 0.44 * L)
    : Math.max(60, 0.55 * L);
  return p <= w;
}
function chanOKStrict(S, H, P) {
  if (dist(S, H) < 150) return bandOKStrict(S, H, P); // chanOK 在 L<150 时退化为 bandOK(含600km捷径) → 换稳健空间带
  return chanOK(S, H, P);
}
function beltV2Robust(S, H, P, fast) {
  if (!S || !H || !P) return 0;
  if (isBlack(S, H, P)) return 0;
...
/* 最优分段规划: 整条无法联程时, 切成 连续区间内段(每组合1次联程) + 全价段, 总次数最少
   ...
   计次 v3(2026-09-19): 闭环组(终点回到本组起点≤40km, 三角形/环形)按往返计 2;
   chainRound 仍整体 ×2(网页端回程段不入链, 维持原口径) */
function planGroups(cc) {
  ...
  c.segs.forEach((sg, i) => {
    ...
    if (fold) { // 折返: 不能与前段合并, 但本段可自成一组联程(分母=本段起点→终点; 回程段 B≈S 时旧分母为 0)
      if (sg.km / (dist(A, B) || 1) <= state.ratio) { cur = { segs: [sg], total: sg.km, i0: i, i1: i }; groups.push(cur); }
      else { cur = null; full.push(sg); }
      return;
    }
    const ratioOk = ((cur ? cur.total : 0) + sg.km) / ((cur ? dist(pts[cur.i0], B) : dist(A, B)) || 1) <= state.ratio;
    if (cur && ratioOk) { cur.segs.push(sg); cur.total += sg.km; cur.i1 = i; return; }
    if (sg.km / (dist(A, B) || 1) <= state.ratio) { cur = { segs: [sg], total: sg.km, i0: i, i1: i }; groups.push(cur); }
    else { cur = null; full.push(sg); }
  });
  const used = groups.reduce((s, g) => {
    const pA = pts[g.i0], pB = pts[g.i1 + 1];
    return s + (pA && pB && dist(pA, pB) <= 40 ? 2 : 1);
  }, 0) * (state.chainRound ? 2 : 1);
  return { groups, full, used };
}
 ...
 * robust=true 时用稳健口径 beltV2Robust/bandOKStrict(不走极短区间捷径, 供区间推荐排序) */
function chainV2(S, H, stList, rStart, rEnd, fast, robust) {
  if (!S || !H) return null;
  const belt = robust ? beltV2Robust : beltV2;
  const band = robust ? bandOKStrict : bandOK;
  const start = rStart || S, end = rEnd || H;
  const pts = [start, ...(stList || []), end];
  const segs = [];
  for (let i = 0; i < pts.length - 1; i++) {
    ...
    if (belt(S, H, A, fast) === 2 && belt(S, H, B, fast) === 2) {
      seg.inInt = true; // 直达: 两端均区间内
    } else if (belt(S, H, A, fast) === 2 && !isBLK2(S, H, B)) {
...
let planned=false;
function routeChainAt(S,H2,robust){
  const sts=state.trips.map(t=>t.station);
  const dep=state.depart||H2;
  if(roundAny()) return chainV2(S,H2,sts,dep,dep,null,robust);           // 全程往返: 出发→各程→回出发
  if(!sts.length) return chainV2(S,H2,[],dep,dep,null,robust);
  return chainV2(S,H2,sts.slice(0,-1),dep,sts[sts.length-1],null,robust); // 单程: 出发→各程(终点=最后一程, 不重复)
}
...
function renderResult(){
  ...
  /* 计次 v3(2026-09-19): 涉及往返一律 2 次 —— 回程段参与切分计次(去1+回1=往返2),
     折返切分各趟各1(A→C+C→B=2), 闭环趟(终点≈本趟起点≤40km, 三角形/环形)计 2, 区间外段不计次断开 */
  const okRuns = [];
  let curR = [];
  cc.segs.forEach((sg, i) => {
    if (!sg.ok) { if (curR.length) { okRuns.push(curR); curR = []; } return; }
    let fold = false;
    if (curR.length) {
      const p = cc.segs[curR[curR.length - 1]];
      fold = (p.b.lon - p.a.lon) * (sg.b.lon - p.b.lon) + (p.b.lat - p.a.lat) * (sg.b.lat - p.b.lat) < 0;
    }
    if (fold) { okRuns.push(curR); curR = []; }
    curR.push(i);
  });
  if (curR.length) okRuns.push(curR);
  used = okRuns.reduce((s, run) => {
  ...
  let html='<div class="card" id="resCard">'+
    ...
    hubLineHtml+
    '<div style="font-size:11px;color:var(--ok);font-weight:600;margin-top:2px">联程 '+okRuns.length+' 趟行程 · 共 '+used+' 次'+(roundAny()?'（含往返）':'')+' · 剩余 '+remain+' 次</div>'+
  ...
  if(sup&&sup.st){
    const betterCover=sup.coverL>curCover;
    const betterDir=!betterCover&&sup.dirN>curDirN;
    const lc=sup.lowConf?' · ⚠ 依赖极短区间放宽规则·把握较低，先买一张实测':'';
    html+=(betterCover
      ?'<div class="rec">把<b>家</b>改成 <b>'+esc(sup.st.name)+' · '+esc(sup.st.city)+'</b> → 联程可出 <b>'+sup.coverL+'/'+N+'</b> 段'+(sup.coverL<N?'（最高）':'')+
        '<div class="mini">覆盖优先 · p/L='+sup.pMax.toFixed(2)+'（越居中越稳）'+lc+'</div></div>'+
  ...
  html+='<details><summary>🎫 次数明细（连续行程怎么计）</summary>'+
    okRuns.map((run, ri) => {
      ...
      return '<div class="mini-row"><div class="n">行程' + (ri + 1) + ' ' + path + '</div><div class="d">' + (closed ? '闭环往返 · 计 2 次' : '全程联程（无绕路）· 计 1 次') + '（' + tags + '）</div></div>';
    }).join('') +
    ...
    '<div style="font-size:11.5px;color:var(--mut);margin-top:6px">规则：连续行程计 1 次；往返（回程/折返/闭环）合计 2 次；区间外段需成人票并断开行程。</div>'+
    '</details>';
...
function chainBestLocal(){
  ...
  for(const s of STATIONS){
    ...
    const ccR=routeChainAt(S,H2,true); // 稳健口径: 不走极短区间同城圈600km捷径(2026-09-19 实测 郑州⇄新乡→天津 被拦)
    const coverR=ccR.okN;
    const ccL=routeChainAt(S,H2);      // 展示口径(与结果面板同源)
    const coverL=ccL.okN;
    if(coverL<curCover)continue;
    const Lh=dist(S,H2);
    let pMax=0,dirN=0;
    for(const sg of ccR.segs){ if(sg.inInt){dirN++;const{p}=corridor(S,H2,sg.b);pMax=Math.max(pMax,p/(Lh||1));} }
    const km=dist({lat:s[2],lon:s[3]},{lat:H.lat,lon:H.lon});
    // 稳健覆盖→展示覆盖→直达段多→区间短→p/L小→距家近 (长区间 p/L 被摊薄, 不再作前位平局键)
    if(!best||coverR>best.coverR||(coverR===best.coverR&&(coverL>best.coverL||(coverL===best.coverL&&(dirN>best.dirN||(dirN===best.dirN&&(Lh<best.Lh||(Lh===best.Lh&&(pMax<best.pMax||(pMax===best.pMax&&km<best.km))))))))))
      best={st:{name:s[0],city:s[1],lat:s[2],lon:s[3]},coverR,coverL,dirN,pMax,Lh,lowConf:coverR<coverL};
  }
  return best;
}
function optRows(){
